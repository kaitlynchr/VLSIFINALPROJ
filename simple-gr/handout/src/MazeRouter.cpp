...
//std::cout<<"hello 4\n";
			...
			if(getGCellId(GCELL1) == getGCellId(GCELL))
			{
				...
				else if( priorityQueue.getGCellData(getGCellId(GCELL2)).totalCost > pathCost+func(EDGEID)+lb(snk,GCELL2) &&priorityQueue.getGCellData(getGCellId(GCELL2)).heapLoc!= NULLID)
				{
					priorityQueue.setGCellCost(getGCellId(GCELL2), pathCost+func(EDGEID)+lb(snk,GCELL2) ,pathCost+func(EDGEID), getGCellId(GCELL)); 
				}
			}	
			else
			{
				...
				else if( priorityQueue.getGCellData(getGCellId(GCELL)).totalCost > pathCost+func(EDGEID)+lb(snk,GCELL2) && priorityQueue.getGCellData(getGCellId(GCELL1)).pathCost != NULLID)
				{
					priorityQueue.setGCellCost(getGCellId(GCELL1), pathCost+func(EDGEID)+lb(snk,GCELL1) ,pathCost+func(EDGEID), getGCellId(GCELL)); 
				}
			}
